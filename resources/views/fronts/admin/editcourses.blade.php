    ...
    <div class="row justify-content-center align-items-center mt-5">
        <div class="col-md-6">
            ...
            <form action="" method="POST" enctype="multipart/form-data">
                ...
                @if ( $courseInfo['image'] != null )
                <div class="mb-4">
                    <img src="{{ get_course_image($courseInfo) }}" alt="" width="100%">
                ...
                <div class="form-group mb-4">
                    ...
                    <input type="text" class="form-control" name="title" value="{{$courseInfo->name}}" required>
                </div>

                <div class="form-group mb-4">
                    <label>Açıklama</label>
                    <textarea class="form-control" name="content" id="content" style="height: 300px;">{{$courseInfo->content}}</textarea>
                </div>
